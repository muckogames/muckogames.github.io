...
(function () {
  ...
  function drawDigoryTD(ctx, x, y, t) {
    __ctx = ctx;
    ctx.save(); ctx.translate(x, y);
    var white = '#f7f5f0', black = '#18181c';
    ell(0, 7, 11.5, 4.2, 'rgba(0,0,0,0.16)');
    ln(-5.3, 6.8, -5.8, 15.3, white, 3);
    ln(-1.4, 7.4, -1,   16,   white, 2.8);
    ln( 2.8, 7.4,  2.5, 15.8, white, 2.8);
    ln( 6,   6.5,  6.8, 14.7, white, 2.8);
    ell(0, 1.5, 12.8, 8.5, white);
    strokeEll(0, 1.5, 12.8, 8.5, C.ink, 2);
    ell( 1.2, -0.9, 5.8, 4, black);
    ell( 5,    1,   3.3, 4, black);
    ell(-6.6,  1.6, 1.8, 2.6, black);
    ell(0, 4.5, 7.8, 2.8, white);
    ell(0, -11.2, 6.4, 6, black);
    strokeEll(0, -11.2, 6.4, 6, C.ink, 2);
    ell(-5.6, -11.3, 1.6, 3.8, black, -0.9);
    strokeEll(-5.6, -11.3, 1.6, 3.8, C.ink, 1, -0.9);
    ell( 5.6, -11.3, 1.6, 3.8, black,  0.9);
    strokeEll( 5.6, -11.3, 1.6, 3.8, C.ink, 1,  0.9);
    cir(-2, -12.5, 0.9, '#fff'); cir(2, -12.5, 0.9, '#fff');
    cir(0, -8, 1.4, black);
    ctx.restore();
  }
